...
## Phase 2 — generate + the deterministic check 🔵 next
...
At the end of Phase 2 the tool is already *honest*: it cannot show a quote that
isn't in a source.

## Phase 3 — judge + honest rendering 🔵
